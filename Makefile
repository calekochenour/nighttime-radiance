...
all: 01-code-scripts/download_laads_order.py 01-code-scripts/preprocess_vnp46a1.py 01-code-scripts/concatenate_vnp46a1.py 01-code-scripts/clip_vnp46a1.py
...
# Delete raw HDF5, preprocessed GeoTiff, and unclipped concatenated GeoTiff files
clean:
